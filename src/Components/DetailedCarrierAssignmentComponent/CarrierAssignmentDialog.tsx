...
const CarrierAssignmentDialog: React.FC<CarrierAssignmentDialogProps> = ({
  open,
  carrierId,
  orderId,
  onClose,
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      try {
        ...
        setSnackbarMessage("Carrier assignment confirmed successfully.");
        ...
        setSnackbarMessage(
          error?.data?.message ?? "Failed to confirm carrier assignment.",
        );
        ...
        >
          ...
          >
            <Stack spacing={0.5}>
              ...
              >
                Provide vehicle and driver details to confirm this order.
              </Typography>
            </Stack>
...
export default CarrierAssignmentDialog;
